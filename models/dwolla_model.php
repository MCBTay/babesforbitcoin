...
class Dwolla_model extends CI_Model
{
	...
	// URL to return the user to after the authentication request
	private $redirectUri = 'http://www.babesforbitcoin.com/';

	// Transaction mode. Can be 'live' or 'test'
	private $mode = 'live';

	// Off-Site Gateway order items
	private $gatewaySession;

	// error messages returned from Dwolla
	private $errorMessage = FALSE;

	// operate in debug mode
	private $debugMode = FALSE;

	// use sandbox for API_SERVER
	private $sandboxMode = FALSE;

	// default URL tail for
	...
	public function __construct()
	{
		...
		$this->apiKey     = decrypt(DWOLLA_KEY);
		$this->apiSecret  = decrypt(DWOLLA_SECRET);
		$this->oauthToken = decrypt(DWOLLA_TOKEN); // For Babes for Bitcoin account
	}
	 ...
	 */
	public function initialize($redirectUri = FALSE, $permissions = FALSE, $mode = FALSE, $debugMode = FALSE, $sandboxMode = FALSE)
	{
		if ($redirectUri)
		{
...
/* Location: ./application/models/dwolla_model.php */